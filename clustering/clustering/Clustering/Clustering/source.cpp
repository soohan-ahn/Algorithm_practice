...
DATA data[300];
int sing_cluster[300][300];
int sing_clust[300];
int sing_clust_cnt[300];
int avg_cluster[300][300];
int avg_clust[300];
int avg_clust_cnt[300];
int lar_cluster[300][300];
int lar_clust[300];
int lar_clust_cnt[300];
int singx,singy;
int larx,lary;
int avgx,avgy;
double dis[300][300];
double temp_sing_dis[300][300];
double temp_lar_dis[300][300];
double temp_avg_dis[300][300];
double temp_avg_num[300][300];
char input_file[300];
